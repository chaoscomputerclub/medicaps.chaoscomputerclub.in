...
export const Route = createFileRoute("/assessments/$contestSlug")({
  head: () => ({
    meta: [
      { title: "Assessment Workspace — CCC Medi-Caps" },
      {
        name: "description",
        content: "Clean, proctored fullscreen competitive assessment workspace.",
      },
    ],
  }),
  component: StandaloneAssessmentPage,
});
...
function StandaloneAssessmentPage() {
  ...
  async function handleFinish() {
    ...
    if (finishAssessmentThunk.fulfilled.match(action)) {
      ...
      if (window.opener) {
        ...
        navigate({ to: "/portal/contests/$contestSlug", params: { contestSlug } });
      }
    }
  }
