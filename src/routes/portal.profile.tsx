...
return <div className="page-wrap"><header className="profile-header">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="profile-sub text-xs text-[var(--muted)] font-mono mt-0.5">@{m.handle} · {m.department} · {m.batch}</p>
        ...
        <div className="flex items-center gap-2 flex-wrap mt-2.5">
          ...
          {m.is_core_member && <span className="proof-seal"><ShieldCheck size={12} /> CORE MEMBER</span>}
          <button
            type="button"
          ...
          >
            <Users size={12} className="text-[var(--accent)] group-hover:scale-110 transition-transform" />
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-mono uppercase bg-[var(--surface-2)] hover:bg-[var(--surface-3)] text-[var(--muted)] hover:text-white border border-[var(--line)] hover:border-[var(--accent)]/50 rounded-[1px] transition-all cursor-pointer group"
          >
            <UserCheck size={12} className="text-[var(--accent)] group-hover:scale-110 transition-transform" />
          ...
          {m.linkedin_url && (
            <a
              href={m.linkedin_url.startsWith("http") ? m.linkedin_url : `https://linkedin.com/in/${m.linkedin_url}`}
              target="_blank"
              rel="noopener noreferrer"
