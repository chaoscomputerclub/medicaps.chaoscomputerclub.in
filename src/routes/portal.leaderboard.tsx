          ...
          <button
            ...
            className={
              followingIds.includes(x.id)
                ? "inline-flex items-center gap-1 font-mono text-[10px] font-bold uppercase px-2 py-1 bg-transparent border border-[#333] text-muted hover:text-danger hover:border-danger rounded-[1px] transition-colors"
                : "inline-flex items-center gap-1 font-mono text-[10px] font-bold uppercase px-2 py-1 bg-accent/10 border border-accent/40 text-accent hover:bg-accent hover:text-black rounded-[1px] transition-colors"
            }
          >
