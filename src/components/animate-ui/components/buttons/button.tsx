    ...
    variants: {
      variant: {
        ...
        lime:
          'bg-lime-400 text-black font-sans font-semibold uppercase text-xs tracking-wider border border-lime-400 hover:bg-lime-300 hover:border-lime-300 active:bg-lime-400 shadow-none transition-colors duration-150 [&_svg]:transition-colors',
        accent:
          'bg-lime-400 text-black font-sans font-semibold uppercase text-xs tracking-wider border border-lime-400 hover:bg-lime-300 hover:border-lime-300 shadow-none transition-colors duration-150 [&_svg]:transition-colors',
        destructive:
