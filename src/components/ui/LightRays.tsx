...
export const LightRays: FC<LightRaysProps> = ({
  ...
  // 1. Intersection Observer to pause rendering when off-screen
  useEffect(() => {
...
void main() {
  ...
  gl_FragColor = color;
    ...
    return () => {
      ...
      // Hide immediately to prevent any compositor clear flash on unmount
      if (gl && gl.canvas) {
