...
export function AssessmentConfirmModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg rounded-none border border-amber-500/40 bg-zinc-950 text-white p-0 gap-0 overflow-hidden shadow-2xl backdrop-blur-2xl">
        {/* Header */}
        <DialogHeader className="p-4 border-b border-white/10 bg-zinc-900/80 backdrop-blur-md flex flex-row items-center justify-between space-y-0">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-none bg-amber-500/10 border border-amber-500/30 text-amber-400">
        ...
        <div className="p-6 space-y-5 overflow-y-auto max-h-[75vh]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 font-mono text-xs">
            <div className="p-3 rounded-none border border-white/10 bg-zinc-900/60 space-y-1">
          ...
          {/* Mandatory Checkbox */}
          <label className="flex items-start gap-3 p-3.5 rounded-none bg-amber-950/20 border border-amber-500/30 cursor-pointer text-left transition-colors hover:bg-amber-950/30">
            <Checkbox
              checked={agreed}
        ...
        <DialogFooter className="p-4 border-t border-white/10 bg-zinc-900/80 backdrop-blur-md flex flex-row justify-end gap-3 space-x-0">
          <Button
            ...
            className="rounded-none border-white/10 font-mono text-xs uppercase text-zinc-300 hover:border-white/20 hover:text-white active:scale-[0.98]"
          >
            Cancel / Not Ready
          </Button>
          ...
          <Button
            ...
            disabled={!agreed}
            className="rounded-none bg-lime-400 text-black hover:bg-lime-400 font-mono text-xs font-bold uppercase tracking-wider px-5 disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-lime-400/20 active:scale-[0.98]"
          >
