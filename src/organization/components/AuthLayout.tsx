...
export function AuthLayout({
  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center bg-zinc-950 px-4 py-12 sm:py-8 overflow-hidden">
      {/* Ambient background grid & lighting */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(249,115,22,0.08)_0%,transparent_70%)]" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-6 flex justify-center">
          <Link
            to="/"
            className="group flex size-20 items-center justify-center rounded-2xl border border-white/10 bg-zinc-900/80 p-3 shadow-2xl transition-all duration-300 hover:scale-105 hover:border-orange-500/60 hover:shadow-[0_0_24px_rgba(249,115,22,0.2)]"
          >
            <img
              src="/logo.png"
        ...
        {/* Main Box Card */}
        <div className="relative z-10 w-full rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl shadow-2xl overflow-hidden">
