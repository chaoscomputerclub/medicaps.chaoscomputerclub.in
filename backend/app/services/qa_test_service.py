    ...
    async def run_full_qa_audit(
        ...
        test_definitions: List[Dict[str, Any]] = [
            ...
            },
            {
                "id": "AUTH-03",
                "category": "Authentication",
                "name": "Invalid Bearer Token Rejection (401)",
                "method": "GET",
                "endpoint": "/api/auth/me",
                "headers": {"Authorization": "Bearer invalid_malformed_token_signature"},
                "body": None,
                "expected_status": 401,
                "required_keys": ["detail"],
                "notes": "Cryptographically validates rejection of invalid tokens without touching email services.",
            },
            {
                "id": "AUTH-04",
                "category": "Authentication",
                "name": "Taken Handle Availability Check",
                "method": "GET",
                "endpoint": "/api/auth/check-handle?handle=admin",
                "headers": {},
                "body": None,
                "expected_status": 200,
                "required_keys": ["available", "handle"],
                "notes": "Validates reserved/registered handle response.",
            },
            {
                "id": "AUTH-05",
                "category": "Authentication",
