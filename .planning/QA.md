...
> **Audit ID**: `QA-20260918-171422`  
> **Timestamp (UTC)**: `2026-09-18T17:14:25.426978+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `3004.8ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 45.38ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 221.53ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 6.88ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.27ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 2.72ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 3.58ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 2.88ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.42ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.42ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 9.74ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 7.2ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 3.64ms |
| 🟢 **Validation & Edge Cases** | 2 | 2 | 0 | **100.0%** | 1.51ms |
...
- **Category**: `System & Health` | **Latency**: `45.38ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 45.38ms)
...
- **Endpoint**: `POST /api/auth/send-otp`
- **Category**: `Authentication` | **Latency**: `2598.92ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'sent', 'message', 'transaction_id', 'email', 'dev_otp']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 2598.92ms)
```json
// Request Body
{
...
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 5.13ms)

### ✅ PASS `[AUTH-06]` Authenticated Member Profile Fetch (/me)
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `21.61ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 21.61ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 10.12ms)
...
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 3.76ms)

### ✅ PASS `[AUTH-09]` Authenticated Full Profile Alias (/profile/full)
- **Endpoint**: `GET /api/auth/profile/full`
- **Category**: `Authentication` | **Latency**: `2.43ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Endpoint**: `GET /api/auth/profile/@qa_organizer`
- **Category**: `Authentication` | **Latency**: `2.28ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['member', 'ratingHistory', 'problemStats']`
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 2.28ms)
...
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.71ms)

### ✅ PASS `[CONTEST-01]` List Official Campus Contests
- **Endpoint**: `GET /api/contests` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `18.96ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 18.96ms)

### ✅ PASS `[CONTEST-02]` Get Specific Contest Overview (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `4.34ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 4.34ms)

### ✅ PASS `[CONTEST-03]` Get Contest Problem Arena (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1/problems` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `2.71ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `2.03ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 2.03ms)
...
- **Category**: `Trust of Proof` | **Latency**: `4.99ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['certificate_id', 'sha256_digest', 'issued_at', 'status']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 4.99ms)

### ✅ PASS `[PROOF-02]` Tamper-Proof Verification Query (Invalid Token)
- **Endpoint**: `POST /api/verify`
- **Category**: `Trust of Proof` | **Latency**: `2.17ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Campus Passes` | **Latency**: `4.53ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Campus Feed` | **Latency**: `3.39ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 3.39ms)
...
- **Category**: `Social & OG` | **Latency**: `2.21ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
...
- **Endpoint**: `GET /api/social/@qa_organizer/followers`
- **Category**: `Social & OG` | **Latency**: `1.68ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
...
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 400 matched expectation. All 1 schema keys present in response object (Latency: 2.2ms)
...
- **Category**: `Social & OG` | **Latency**: `7.92ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 7.92ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `26.95ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 26.95ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `3.57ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 3.57ms)
```json
// Request Body
{
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `9.46ms`
- **Expected Status**: `HTTP 201` ➔ **Actual Status**: `HTTP 201`
- **Expected Schema**: `Keys: ['success', 'slug', 'contest_id']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest_id', 'slug', 'title', 'cadence', 'edition', 'status']`
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 9.46ms)
```json
// Request Body
{
  "new_title": "CCC Weekly Contest 999 \u2014 Edition 2",
  "new_slug": "weekly-contest-999-v2",
  "starts_at": "2026-09-25T17:14:22.544610+00:00",
  "ends_at": "2026-09-25T20:14:22.544622+00:00"
}
```

### ✅ PASS `[DYNAMIC-06]` Cascade Delete QA Contests
- **Endpoint**: `DELETE /api/admin/contests/weekly-contest-999`
- **Category**: `Dynamic Contest Engine` | **Latency**: `11.55ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 11.55ms)
...
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 6.75ms)

### ✅ PASS `[ASSESS-01]` Fetch Screening Assessment Status (weekly-contest-1)
- **Endpoint**: `GET /api/assessment/weekly-contest-1`
- **Category**: `Assessment Service` | **Latency**: `3.64ms`
- **Expected Status**: `HTTP [200, 403, 404]` ➔ **Actual Status**: `HTTP 403`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 403 matched expectation. No specific schema required (Latency: 3.64ms)

### ✅ PASS `[EDGE-01]` Admin Dynamic Create Payload Missing Required Fields (422)
- **Endpoint**: `POST /api/admin/contests`
- **Category**: `Validation & Edge Cases` | **Latency**: `1.72ms`
- **Expected Status**: `HTTP 422` ➔ **Actual Status**: `HTTP 422`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 422 matched expectation. All 1 schema keys present in response object (Latency: 1.72ms)
```json
// Request Body
{
...
- **Category**: `Validation & Edge Cases` | **Latency**: `1.3ms`
- **Expected Status**: `HTTP 401` ➔ **Actual Status**: `HTTP 401`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 1.3ms)
