...
> **Audit ID**: `QA-20260919-153721`  
> **Timestamp (UTC)**: `2026-09-19T15:37:22.263317+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `334.03ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 34.0ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 2.9ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 4.56ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.16ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 1.83ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.64ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.15ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 1.97ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.42ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 10.21ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 5.88ms |
...
- **Category**: `System & Health` | **Latency**: `34.0ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 34.0ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 8.94ms)

### ✅ PASS `[AUTH-07]` Student Public Profile View (/profile/{handle})
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `6.57ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 6.57ms)
...
- **Category**: `Contests` | **Latency**: `11.67ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 11.67ms)
...
- **Category**: `Scoreboards` | **Latency**: `1.65ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 1.65ms)
...
- **Category**: `Campus Feed` | **Latency**: `2.37ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 2.37ms)
...
- **Category**: `Social & OG` | **Latency**: `6.65ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 6.65ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `28.54ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 28.54ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `7.22ms`
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 7.22ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `6.68ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 6.68ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `2.77ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 2.77ms)
```json
// Request Body
{
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `4.11ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 4.11ms)
```json
// Request Body
{
  "status": "live"
...
// Request Body
{
  ...
  "starts_at": "2026-09-26T15:37:22.039080+00:00",
  "ends_at": "2026-09-26T18:37:22.039089+00:00"
}
```
