...
> **Audit ID**: `QA-20260921-095829`  
> **Timestamp (UTC)**: `2026-09-21T09:58:29.977074+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `374.13ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 34.72ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 2.84ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 4.77ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.24ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 2.22ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 3.39ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.59ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.67ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.59ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 10.94ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 8.55ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 7.63ms |
| 🟢 **Validation & Edge Cases** | 2 | 2 | 0 | **100.0%** | 1.45ms |
...
- **Category**: `System & Health` | **Latency**: `34.72ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 34.72ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 9.13ms)
...
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `3.89ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Contests` | **Latency**: `12.37ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 12.37ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `1.78ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Trust of Proof` | **Latency**: `5.11ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['certificate_id', 'sha256_digest', 'issued_at', 'status']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 5.11ms)
...
- **Category**: `Campus Passes` | **Latency**: `5.97ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Category**: `Campus Feed` | **Latency**: `2.07ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'kind']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 2.07ms)
...
- **Endpoint**: `POST /api/social/toggle/qa_target`
- **Category**: `Social & OG` | **Latency**: `4.81ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'is_following', 'followers_count', 'following_count']`
- **Actual Response**: `Dict with keys: ['success', 'is_following', 'followers_count', 'following_count', 'target_id', 'target_handle', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.81ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `30.95ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 30.95ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `19.5ms`
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 19.5ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 10.27ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `3.28ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 3.28ms)
```json
// Request Body
{
...
- **Expected Schema**: `Keys: ['success', 'slug', 'contest_id']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest_id', 'slug', 'title', 'cadence', 'edition', 'status']`
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 6.26ms)
```json
// Request Body
{
  "new_title": "CCC Weekly Contest 999 \u2014 Edition 2",
  "new_slug": "weekly-contest-999-v2",
  "starts_at": "2026-09-28T09:58:29.719597+00:00",
  "ends_at": "2026-09-28T12:58:29.719606+00:00"
}
```
...
- **Category**: `Assessment Service` | **Latency**: `7.63ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 7.63ms)

### ✅ PASS `[EDGE-01]` Admin Dynamic Create Payload Missing Required Fields (422)
- **Endpoint**: `POST /api/admin/contests`
- **Category**: `Validation & Edge Cases` | **Latency**: `2.21ms`
- **Expected Status**: `HTTP 422` ➔ **Actual Status**: `HTTP 422`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 422 matched expectation. All 1 schema keys present in response object (Latency: 2.21ms)
```json
// Request Body
{
