...
> **Audit ID**: `QA-20260919-103707`  
> **Timestamp (UTC)**: `2026-09-19T10:37:10.551102+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `3108.8ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 32.37ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 233.73ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 5.42ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.17ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 2.35ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.4ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.47ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 3.33ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.11ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 8.7ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 6.37ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 3.67ms |
...
- **Category**: `System & Health` | **Latency**: `32.37ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 32.37ms)

### ✅ PASS `[AUTH-01]` RSA 256 JWT Public Key Fetch
- **Endpoint**: `GET /api/auth/jwt-public-key`
- **Category**: `Authentication` | **Latency**: `4.16ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['algorithm', 'public_key']`
- **Actual Response**: `Dict with keys: ['algorithm', 'public_key']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 4.16ms)

### ✅ PASS `[AUTH-02]` Handle Availability Check (Available)
- **Endpoint**: `GET /api/auth/check-handle?handle=qa_cadet_unique_99`
- **Category**: `Authentication` | **Latency**: `1.94ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Authentication` | **Latency**: `0.84ms`
- **Expected Status**: `HTTP [400, 422]` ➔ **Actual Status**: `HTTP 422`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 422 matched expectation. All 1 schema keys present in response object (Latency: 0.84ms)
```json
// Request Body
{
...
- **Endpoint**: `POST /api/auth/send-otp`
- **Category**: `Authentication` | **Latency**: `2761.93ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'sent', 'message', 'transaction_id', 'email', 'dev_otp']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 2761.93ms)
```json
// Request Body
{
...
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 1.42ms)

### ✅ PASS `[AUTH-06]` Authenticated Member Profile Fetch (/me)
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `13.97ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 13.97ms)

### ✅ PASS `[AUTH-07]` Student Public Profile View (/profile/{handle})
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `9.17ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 9.17ms)
...
- **Category**: `Authentication` | **Latency**: `1.06ms`
...
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `4.68ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['member', 'problemStats', 'ratingHistory', 'recentBattles']`
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.68ms)

### ✅ PASS `[CONTEST-01]` List Official Campus Contests
- **Endpoint**: `GET /api/contests` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `13.65ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 13.65ms)

### ✅ PASS `[CONTEST-02]` Get Specific Contest Overview (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `3.9ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 3.9ms)

### ✅ PASS `[CONTEST-03]` Get Contest Problem Arena (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1/problems` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `2.64ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.64ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `4.39ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys verified in list items (Latency: 4.39ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `1.51ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Scoreboards` | **Latency**: `2.61ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.61ms)
...
- **Category**: `Scoreboards` | **Latency**: `2.09ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.09ms)

### ✅ PASS `[PROOF-01]` List Cryptographic Trust Proofs
- **Endpoint**: `GET /api/verify/proofs` `[Cache: MISS]`
- **Category**: `Trust of Proof` | **Latency**: `3.08ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Trust of Proof` | **Latency**: `1.71ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Campus Passes` | **Latency**: `4.63ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Campus Passes` | **Latency**: `2.31ms`
- **Expected Status**: `HTTP 404` ➔ **Actual Status**: `HTTP 404`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 404 matched expectation. All 1 schema keys present in response object (Latency: 2.31ms)

### ✅ PASS `[FEED-01]` List Campus Announcements & Bulletins
- **Endpoint**: `GET /api/feed/announcements` `[Cache: MISS]`
- **Category**: `Campus Feed` | **Latency**: `4.79ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 4.79ms)

### ✅ PASS `[FEED-02]` Filter Announcements by Category
- **Endpoint**: `GET /api/feed/announcements?kind=system` `[Cache: MISS]`
- **Category**: `Campus Feed` | **Latency**: `1.87ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'kind']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 1.87ms)

### ✅ PASS `[SOCIAL-01]` Cadet Followers Network Query
- **Endpoint**: `GET /api/social/qa_organizer/followers`
- **Category**: `Social & OG` | **Latency**: `7.34ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 7.34ms)
...
- **Category**: `Social & OG` | **Latency**: `2.24ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['following_ids']`
- **Actual Response**: `Dict with keys: ['following_ids']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 2.24ms)
...
- **Category**: `Social & OG` | **Latency**: `1.73ms`
- **Expected Status**: `HTTP 400` ➔ **Actual Status**: `HTTP 400`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 400 matched expectation. All 1 schema keys present in response object (Latency: 1.73ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 5.81ms)

### ✅ PASS `[SOCIAL-08]` Atomic Toggle Unfollow Peer Cadet (POST /social/toggle second pass)
- **Endpoint**: `POST /api/social/toggle/qa_target`
- **Category**: `Social & OG` | **Latency**: `4.19ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'is_following', 'followers_count', 'following_count']`
- **Actual Response**: `Dict with keys: ['success', 'is_following', 'followers_count', 'following_count', 'target_id', 'target_handle', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.19ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `24.3ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 24.3ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `6.92ms`
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 6.92ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `6.06ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 6.06ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `2.93ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 2.93ms)
```json
// Request Body
{
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `4.23ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 4.23ms)
```json
// Request Body
{
  "status": "live"
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `5.67ms`
- **Expected Status**: `HTTP 201` ➔ **Actual Status**: `HTTP 201`
- **Expected Schema**: `Keys: ['success', 'slug', 'contest_id']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest_id', 'slug', 'title', 'cadence', 'edition', 'status']`
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 5.67ms)
```json
// Request Body
{
  "new_title": "CCC Weekly Contest 999 \u2014 Edition 2",
  "new_slug": "weekly-contest-999-v2",
  "starts_at": "2026-09-26T10:37:07.553949+00:00",
  "ends_at": "2026-09-26T13:37:07.553959+00:00"
}
```

### ✅ PASS `[DYNAMIC-06]` Cascade Delete QA Contests
- **Endpoint**: `DELETE /api/admin/contests/weekly-contest-999`
- **Category**: `Dynamic Contest Engine` | **Latency**: `9.86ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 9.86ms)

### ✅ PASS `[DYNAMIC-07]` Cascade Delete Cloned QA Contest
- **Endpoint**: `DELETE /api/admin/contests/weekly-contest-999-v2`
- **Category**: `Dynamic Contest Engine` | **Latency**: `8.92ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 8.92ms)

### ✅ PASS `[ASSESS-01]` Fetch Screening Assessment Status (weekly-contest-1)
- **Endpoint**: `GET /api/assessment/weekly-contest-1`
- **Category**: `Assessment Service` | **Latency**: `3.67ms`
- **Expected Status**: `HTTP [200, 403, 404]` ➔ **Actual Status**: `HTTP 403`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 403 matched expectation. No specific schema required (Latency: 3.67ms)
...
- **Category**: `Validation & Edge Cases` | **Latency**: `1.23ms`
- **Expected Status**: `HTTP 401` ➔ **Actual Status**: `HTTP 401`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 1.23ms)
