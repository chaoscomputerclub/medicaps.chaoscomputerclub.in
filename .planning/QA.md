...
> **Audit ID**: `QA-20260919-154714`  
> **Timestamp (UTC)**: `2026-09-19T15:47:14.466785+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `345.01ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 32.62ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 2.85ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 4.47ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.08ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 1.79ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.62ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.07ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 1.86ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.71ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 11.44ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 7.0ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 3.39ms |
| 🟢 **Validation & Edge Cases** | 2 | 2 | 0 | **100.0%** | 1.66ms |
...
- **Category**: `System & Health` | **Latency**: `32.62ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 32.62ms)
...
- **Expected Schema**: `Keys: ['available', 'handle']`
- **Actual Response**: `Dict with keys: ['available', 'handle']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 1.02ms)
...
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `8.96ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 8.96ms)

### ✅ PASS `[AUTH-07]` Student Public Profile View (/profile/{handle})
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `6.3ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 6.3ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `4.09ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys verified in list items (Latency: 4.09ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 2.09ms)

### ✅ PASS `[LEADER-03]` Rating Distribution Histogram
- **Endpoint**: `GET /api/leaderboard/distribution` `[Cache: MISS]`
- **Category**: `Leaderboards & Ratings` | **Latency**: `1.43ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Scoreboards` | **Latency**: `1.6ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 1.6ms)
...
- **Category**: `Trust of Proof` | **Latency**: `2.12ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Campus Feed` | **Latency**: `2.25ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 2.25ms)
...
- **Category**: `Social & OG` | **Latency**: `7.84ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 7.84ms)

### ✅ PASS `[SOCIAL-08]` Atomic Toggle Unfollow Peer Cadet (POST /social/toggle second pass)
- **Endpoint**: `POST /api/social/toggle/qa_target`
- **Category**: `Social & OG` | **Latency**: `7.25ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `31.73ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 31.73ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `7.67ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 7.67ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `3.61ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 3.61ms)
```json
// Request Body
{
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `4.84ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
// Request Body
{
  ...
  "starts_at": "2026-09-26T15:47:14.230444+00:00",
  "ends_at": "2026-09-26T18:47:14.230454+00:00"
}
```

### ✅ PASS `[DYNAMIC-06]` Cascade Delete QA Contests
- **Endpoint**: `DELETE /api/admin/contests/weekly-contest-999`
- **Category**: `Dynamic Contest Engine` | **Latency**: `11.0ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Assessment Service` | **Latency**: `3.39ms`
- **Expected Status**: `HTTP [200, 403, 404]` ➔ **Actual Status**: `HTTP 403`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 403 matched expectation. No specific schema required (Latency: 3.39ms)

### ✅ PASS `[EDGE-01]` Admin Dynamic Create Payload Missing Required Fields (422)
- **Endpoint**: `POST /api/admin/contests`
- **Category**: `Validation & Edge Cases` | **Latency**: `2.27ms`
- **Expected Status**: `HTTP 422` ➔ **Actual Status**: `HTTP 422`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 422 matched expectation. All 1 schema keys present in response object (Latency: 2.27ms)
```json
// Request Body
{
