...
> **Audit ID**: `QA-20260921-222407`  
> **Timestamp (UTC)**: `2026-09-21T22:24:08.019858+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `375.96ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 34.73ms |
...
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 10.38ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 5.67ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 4.69ms |
...
- **Category**: `System & Health` | **Latency**: `34.73ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 34.73ms)
...
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `9.08ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 9.08ms)
...
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.05ms)

### ✅ PASS `[CONTEST-01]` List Official Campus Contests
- **Endpoint**: `GET /api/contests` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `12.32ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 12.32ms)
...
- **Category**: `Social & OG` | **Latency**: `8.13ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 8.13ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 2.94ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 7.26ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `29.1ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 29.1ms)
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 6.8ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 5.77ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `5.4ms`
- **Expected Status**: `HTTP 201` ➔ **Actual Status**: `HTTP 201`
- **Expected Schema**: `Keys: ['success', 'slug', 'contest_id']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest_id', 'slug', 'title', 'cadence', 'edition', 'status']`
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 5.4ms)
```json
// Request Body
{
  "new_title": "CCC Weekly Contest 999 \u2014 Edition 2",
  "new_slug": "weekly-contest-999-v2",
  "starts_at": "2026-09-28T22:24:07.787947+00:00",
  "ends_at": "2026-09-29T01:24:07.787957+00:00"
}
```
...
- **Category**: `Assessment Service` | **Latency**: `4.69ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 4.69ms)

### ✅ PASS `[EDGE-01]` Admin Dynamic Create Payload Missing Required Fields (422)
- **Endpoint**: `POST /api/admin/contests`
- **Category**: `Validation & Edge Cases` | **Latency**: `1.91ms`
