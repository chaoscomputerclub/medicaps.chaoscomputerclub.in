...
> **Audit ID**: `QA-20260922-130048`  
> **Timestamp (UTC)**: `2026-09-22T13:00:48.711406+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `347.7ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 34.86ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 2.74ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 5.06ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.67ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 2.95ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.95ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.28ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.59ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.26ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 10.78ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 6.1ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 6.56ms |
...
- **Category**: `System & Health` | **Latency**: `34.86ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 34.86ms)
...
- **Category**: `Authentication` | **Latency**: `6.08ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 6.08ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `5.63ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['rank', 'handle', 'rating', 'department', 'tier', 'ratings']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 5.63ms)
...
- **Category**: `Scoreboards` | **Latency**: `3.02ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Scoreboards` | **Latency**: `2.88ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Trust of Proof` | **Latency**: `4.27ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['certificate_id', 'sha256_digest', 'issued_at', 'status']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 4.27ms)
...
- **Category**: `Campus Passes` | **Latency**: `5.36ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Social & OG` | **Latency**: `8.41ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 8.41ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 2.74ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 4.85ms)
...
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 0.82ms)
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 6.68ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 6.22ms)
```json
// Request Body
{
  "status": "live"
...
// Request Body
{
  ...
  "starts_at": "2026-09-29T13:00:48.474701+00:00",
  "ends_at": "2026-09-29T16:00:48.474710+00:00"
}
```
...
- **Category**: `Assessment Service` | **Latency**: `6.56ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 6.56ms)
