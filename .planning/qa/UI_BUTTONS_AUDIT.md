...
**Generated**: `2026-09-21T18:19:01.212Z`  
**Total Audited Elements**: `277`  
...
| :--- | :---: | :--- |
| 🟢 **Live Backend Mutation** | `33` | Triggers API POST/PUT/DELETE, Redux Thunks, or database mutations |
| 🟢 **Live Backend Query** | `9` | Triggers live backend SWR cache queries & data refetches |
| 🔵 **Routing & Navigation** | `176` | Navigates between platform routes via React Router |
| 🟡 **Client UI State Toggle** | `40` | Controls modals, drawers, tab bars, clipboard copy, and UI toggles |
