...
> **Audit ID**: `QA-20260917-094714`  
> **Timestamp (UTC)**: `2026-09-17T09:47:14.953590+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `369.69ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 42.97ms |
...
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 3.29ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.31ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.54ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.96ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 9.4ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 7.09ms |
...
- **Category**: `System & Health` | **Latency**: `42.97ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 42.97ms)
...
- **Endpoint**: `POST /api/auth/send-otp`
- **Category**: `Authentication` | **Latency**: `2.04ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Authentication` | **Latency**: `6.8ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 6.8ms)
...
- **Category**: `Contests` | **Latency**: `3.53ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 3.53ms)

### ✅ PASS `[CONTEST-03]` Get Contest Problem Arena (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1/problems` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `2.99ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.99ms)
...
- **Category**: `Scoreboards` | **Latency**: `4.31ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Category**: `Scoreboards` | **Latency**: `3.47ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Trust of Proof` | **Latency**: `4.78ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['certificate_id', 'sha256_digest', 'issued_at', 'status']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 4.78ms)
...
- **Category**: `Campus Passes` | **Latency**: `5.15ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 5.15ms)

### ✅ PASS `[PASS-02]` Invalid Pass Code Lookup (404)
- **Endpoint**: `GET /api/passes/INVALID_PASS_9999`
- **Category**: `Campus Passes` | **Latency**: `1.47ms`
- **Expected Status**: `HTTP 404` ➔ **Actual Status**: `HTTP 404`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 404 matched expectation. All 1 schema keys present in response object (Latency: 1.47ms)
...
- **Category**: `Social & OG` | **Latency**: `3.4ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['following_ids']`
- **Actual Response**: `Dict with keys: ['following_ids']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 3.4ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `26.26ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 26.26ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `8.57ms`
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 8.57ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
// Request Body
{
  ...
  "starts_at": "2026-09-24T09:47:14.697663+00:00",
  "ends_at": "2026-09-24T12:47:14.697673+00:00"
}
```
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 10.11ms)
