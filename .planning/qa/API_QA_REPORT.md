...
> **Audit ID**: `QA-20260919-124338`  
> **Timestamp (UTC)**: `2026-09-19T12:43:38.828206+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `405.68ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 48.08ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 3.88ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 5.12ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.3ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 2.18ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.53ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.19ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.08ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.74ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 12.79ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 7.12ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 3.21ms |
...
- **Category**: `System & Health` | **Latency**: `48.08ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 48.08ms)
...
- **Assertion Result**: ✓ Status HTTP 422 matched expectation. All 1 schema keys present in response object (Latency: 1.91ms)
```json
// Request Body
{
...
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `14.17ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 14.17ms)
...
- **Category**: `Authentication` | **Latency**: `3.07ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['member', 'ratingHistory', 'problemStats']`
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 3.07ms)
...
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `4.13ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Contests` | **Latency**: `13.6ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 13.6ms)
...
- **Category**: `Contests` | **Latency**: `2.83ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.83ms)

### ✅ PASS `[CONTEST-04]` Non-Existent Contest 404 Assertion
- **Endpoint**: `GET /api/contests/invalid-contest-slug-nonexistent`
- **Category**: `Contests` | **Latency**: `1.16ms`
- **Expected Status**: `HTTP 404` ➔ **Actual Status**: `HTTP 404`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
...
- **Category**: `Trust of Proof` | **Latency**: `3.25ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['certificate_id', 'sha256_digest', 'issued_at', 'status']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 3.25ms)

### ✅ PASS `[PROOF-02]` Tamper-Proof Verification Query (Invalid Token)
- **Endpoint**: `POST /api/verify`
- **Category**: `Trust of Proof` | **Latency**: `1.81ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Campus Passes` | **Latency**: `4.94ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 4.94ms)

### ✅ PASS `[PASS-02]` Invalid Pass Code Lookup (404)
- **Endpoint**: `GET /api/passes/INVALID_PASS_9999`
- **Category**: `Campus Passes` | **Latency**: `1.44ms`
- **Expected Status**: `HTTP 404` ➔ **Actual Status**: `HTTP 404`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
...
- **Category**: `Campus Feed` | **Latency**: `2.65ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 2.65ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 7.92ms)

### ✅ PASS `[SOCIAL-02]` Cadet Following Network Query
- **Endpoint**: `GET /api/social/qa_organizer/following`
- **Category**: `Social & OG` | **Latency**: `3.16ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 3.16ms)
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 4.22ms)
...
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 400 matched expectation. All 1 schema keys present in response object (Latency: 2.05ms)
...
- **Category**: `Social & OG` | **Latency**: `6.31ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 6.31ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `32.72ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 32.72ms)

### ✅ PASS `[V1-02]` v1 Contests Resource Gateway
- **Endpoint**: `GET /api/v1/contests` `[Cache: HIT]`
- **Category**: `Versioned v1 Gateway` | **Latency**: `4.48ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'slug', 'status']`
- **Actual Response**: `List [1 items]. First item keys: ['id', 'slug', 'title', 'season', 'status', 'division', 'starts_at', 'ends_at']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 4.48ms)
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `3.95ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'contest']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 3.95ms)
```json
// Request Body
{
...
// Request Body
{
  ...
  "starts_at": "2026-09-26T12:43:38.555055+00:00",
  "ends_at": "2026-09-26T15:43:38.555066+00:00"
}
```

### ✅ PASS `[DYNAMIC-06]` Cascade Delete QA Contests
- **Endpoint**: `DELETE /api/admin/contests/weekly-contest-999`
- **Category**: `Dynamic Contest Engine` | **Latency**: `10.16ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 10.16ms)
...
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 6.2ms)

### ✅ PASS `[ASSESS-01]` Fetch Screening Assessment Status (weekly-contest-1)
- **Endpoint**: `GET /api/assessment/weekly-contest-1`
- **Category**: `Assessment Service` | **Latency**: `3.21ms`
- **Expected Status**: `HTTP [200, 403, 404]` ➔ **Actual Status**: `HTTP 403`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 403 matched expectation. No specific schema required (Latency: 3.21ms)
...
- **Category**: `Validation & Edge Cases` | **Latency**: `0.74ms`
- **Expected Status**: `HTTP 401` ➔ **Actual Status**: `HTTP 401`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 0.74ms)
