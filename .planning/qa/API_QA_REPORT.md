...
> **Audit ID**: `QA-20260919-152723`  
> **Timestamp (UTC)**: `2026-09-19T15:27:23.597227+00:00`  
> **Target Base URL**: `http://testserver`  
> **Overall Success Rate**: **`100.0%`** (51/51 Tests Passed)  
> **Total Execution Latency**: `353.42ms`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| 🟢 **System & Health** | 1 | 1 | 0 | **100.0%** | 40.16ms |
| 🟢 **Authentication** | 12 | 12 | 0 | **100.0%** | 2.88ms |
| 🟢 **Contests** | 4 | 4 | 0 | **100.0%** | 5.45ms |
| 🟢 **Leaderboards & Ratings** | 4 | 4 | 0 | **100.0%** | 2.25ms |
| 🟢 **Scoreboards** | 2 | 2 | 0 | **100.0%** | 1.96ms |
| 🟢 **Trust of Proof** | 2 | 2 | 0 | **100.0%** | 2.67ms |
| 🟢 **Campus Passes** | 2 | 2 | 0 | **100.0%** | 3.25ms |
| 🟢 **Campus Feed** | 2 | 2 | 0 | **100.0%** | 2.04ms |
| 🟢 **Social & OG** | 9 | 9 | 0 | **100.0%** | 3.14ms |
| 🟢 **Versioned v1 Gateway** | 3 | 3 | 0 | **100.0%** | 10.56ms |
| 🟢 **Dynamic Contest Engine** | 7 | 7 | 0 | **100.0%** | 6.68ms |
| 🟢 **Assessment Service** | 1 | 1 | 0 | **100.0%** | 2.96ms |
| 🟢 **Validation & Edge Cases** | 2 | 2 | 0 | **100.0%** | 1.18ms |
...
- **Category**: `System & Health` | **Latency**: `40.16ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 40.16ms)

### ✅ PASS `[AUTH-01]` RSA 256 JWT Public Key Fetch
- **Endpoint**: `GET /api/auth/jwt-public-key`
- **Category**: `Authentication` | **Latency**: `4.24ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['algorithm', 'public_key']`
- **Actual Response**: `Dict with keys: ['algorithm', 'public_key']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 4.24ms)
...
- **Endpoint**: `GET /api/auth/me`
- **Category**: `Authentication` | **Latency**: `10.29ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 10.29ms)

### ✅ PASS `[AUTH-07]` Student Public Profile View (/profile/{handle})
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `6.53ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 6.53ms)
...
- **Endpoint**: `GET /api/auth/profile/qa_organizer`
- **Category**: `Authentication` | **Latency**: `4.28ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['member', 'problemStats', 'ratingHistory', 'recentBattles']`
- **Actual Response**: `Dict with keys: ['member', 'ratingHistory', 'recentBattles', 'problemStats', 'submissionCalendar', 'proofs', 'achievements']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys present in response object (Latency: 4.28ms)

### ✅ PASS `[CONTEST-01]` List Official Campus Contests
- **Endpoint**: `GET /api/contests` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `13.99ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 8 schema keys verified in list items (Latency: 13.99ms)

### ✅ PASS `[CONTEST-02]` Get Specific Contest Overview (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `3.77ms`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 3.77ms)

### ✅ PASS `[CONTEST-03]` Get Contest Problem Arena (weekly-contest-1)
- **Endpoint**: `GET /api/contests/weekly-contest-1/problems` `[Cache: MISS]`
- **Category**: `Contests` | **Latency**: `2.93ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. No specific schema required (Latency: 2.93ms)
...
- **Category**: `Leaderboards & Ratings` | **Latency**: `4.63ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys verified in list items (Latency: 4.63ms)

### ✅ PASS `[LEADER-02]` Departmental Aggregate Ratings
- **Endpoint**: `GET /api/leaderboard/departments` `[Cache: MISS]`
- **Category**: `Leaderboards & Ratings` | **Latency**: `2.06ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 2.06ms)
...
- **Category**: `Trust of Proof` | **Latency**: `2.25ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Category**: `Campus Passes` | **Latency**: `5.07ms`
- **Expected Status**: `HTTP [200, 404]` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `List [0 items]. First item keys: primitive`
...
- **Category**: `Campus Passes` | **Latency**: `1.42ms`
- **Expected Status**: `HTTP 404` ➔ **Actual Status**: `HTTP 404`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
...
- **Category**: `Campus Feed` | **Latency**: `2.52ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'content', 'kind', 'published_at']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 2.52ms)

### ✅ PASS `[FEED-02]` Filter Announcements by Category
- **Endpoint**: `GET /api/feed/announcements?kind=system` `[Cache: MISS]`
- **Category**: `Campus Feed` | **Latency**: `1.56ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'kind']`
- **Actual Response**: `List [0 items]. First item keys: primitive`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. Valid (empty list returned as expected) (Latency: 1.56ms)

### ✅ PASS `[SOCIAL-01]` Cadet Followers Network Query
- **Endpoint**: `GET /api/social/qa_organizer/followers`
- **Category**: `Social & OG` | **Latency**: `7.44ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['count', 'students']`
- **Actual Response**: `Dict with keys: ['count', 'followers_count', 'following_count', 'students']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 7.44ms)
...
- **Category**: `Social & OG` | **Latency**: `2.0ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['following_ids']`
- **Actual Response**: `Dict with keys: ['following_ids']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 1 schema keys present in response object (Latency: 2.0ms)
...
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 400 matched expectation. All 1 schema keys present in response object (Latency: 2.08ms)
...
- **Category**: `Social & OG` | **Latency**: `5.58ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 6 schema keys present in response object (Latency: 5.58ms)
...
- **Category**: `Versioned v1 Gateway` | **Latency**: `28.88ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 28.88ms)

### ✅ PASS `[V1-02]` v1 Contests Resource Gateway
- **Endpoint**: `GET /api/v1/contests` `[Cache: HIT]`
- **Category**: `Versioned v1 Gateway` | **Latency**: `1.45ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['id', 'title', 'slug', 'status']`
- **Actual Response**: `List [1 items]. First item keys: ['id', 'slug', 'title', 'season', 'status', 'division', 'starts_at', 'ends_at']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 1.45ms)

### ✅ PASS `[V1-03]` v1 Leaderboard Resource Gateway
- **Endpoint**: `GET /api/v1/leaderboard` `[Cache: HIT]`
- **Category**: `Versioned v1 Gateway` | **Latency**: `1.34ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['rank', 'handle', 'rating', 'department']`
- **Actual Response**: `List [2 items]. First item keys: ['id', 'avatar_url', 'rank', 'university_rank', 'previous_rank', 'handle', 'full_name', 'prn']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 4 schema keys verified in list items (Latency: 1.34ms)

### ✅ PASS `[DYNAMIC-01]` Launch Preset Contest (QA Weekly #999)
- **Endpoint**: `POST /api/admin/contests/preset/launch`
- **Category**: `Dynamic Contest Engine` | **Latency**: `11.58ms`
...
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 11.58ms)
```json
// Request Body
{
  "contest_type": "weekly",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `7.08ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
...
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 3 schema keys present in response object (Latency: 7.08ms)
```json
// Request Body
{
  "problem_index": "D",
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `5.87ms`
- **Expected Status**: `HTTP 201` ➔ **Actual Status**: `HTTP 201`
- **Expected Schema**: `Keys: ['success', 'slug', 'contest_id']`
- **Actual Response**: `Dict with keys: ['success', 'message', 'contest_id', 'slug', 'title', 'cadence', 'edition', 'status']`
- **Assertion Result**: ✓ Status HTTP 201 matched expectation. All 3 schema keys present in response object (Latency: 5.87ms)
```json
// Request Body
{
  "new_title": "CCC Weekly Contest 999 \u2014 Edition 2",
  "new_slug": "weekly-contest-999-v2",
  "starts_at": "2026-09-26T15:27:23.358548+00:00",
  "ends_at": "2026-09-26T18:27:23.358558+00:00"
}
```
...
- **Category**: `Dynamic Contest Engine` | **Latency**: `5.62ms`
- **Expected Status**: `HTTP 200` ➔ **Actual Status**: `HTTP 200`
- **Expected Schema**: `Keys: ['success', 'message']`
- **Actual Response**: `Dict with keys: ['success', 'message']`
- **Assertion Result**: ✓ Status HTTP 200 matched expectation. All 2 schema keys present in response object (Latency: 5.62ms)

### ✅ PASS `[ASSESS-01]` Fetch Screening Assessment Status (weekly-contest-1)
- **Endpoint**: `GET /api/assessment/weekly-contest-1`
- **Category**: `Assessment Service` | **Latency**: `2.96ms`
- **Expected Status**: `HTTP [200, 403, 404]` ➔ **Actual Status**: `HTTP 403`
- **Expected Schema**: `Any valid response`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 403 matched expectation. No specific schema required (Latency: 2.96ms)
...
- **Category**: `Validation & Edge Cases` | **Latency**: `0.84ms`
- **Expected Status**: `HTTP 401` ➔ **Actual Status**: `HTTP 401`
- **Expected Schema**: `Keys: ['detail']`
- **Actual Response**: `Dict with keys: ['detail']`
- **Assertion Result**: ✓ Status HTTP 401 matched expectation. All 1 schema keys present in response object (Latency: 0.84ms)
